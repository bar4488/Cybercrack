...
namespace Cyberfuck
{
    class Player: DrawableGameObject, IFocusable
    {
        ...
        public Point Position { get => new Point((int)box.Bounds.X, (int)box.Bounds.Y); }
        public Vector2 PositionV { get => new Vector2(box.Bounds.X, box.Bounds.Y); }
        public Rectangle Bounds { get => new Rectangle((int)box.Bounds.X, (int)box.Bounds.Y, (int)box.Bounds.Width, (int)box.Bounds.Height);  }
